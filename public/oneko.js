...
// changes:
// - spawn on div with id "oneko-spawn"
...
function oneko() {
	...
	function init() {
		...
		if (persistPosition) {
			...
			if (storedNeko !== null) {
				...
				home = storedNeko.home;
				chasing = storedNeko.chasing;
			}
		}
	...
	function frame() {
		...
		} else if (distance < nekoSpeed) {
			home = true;

			nekoEl.style.left = `${homePosX - 16}px`;
			nekoEl.style.top = `${homePosY - 16}px`;
